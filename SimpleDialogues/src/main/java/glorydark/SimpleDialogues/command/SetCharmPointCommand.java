...
public class SetCharmPointCommand extends Command {

    public SetCharmPointCommand() {
        super("设置魅力值", "设置魅力值", "/设置魅力值 玩家名 魅力值数量");
    }
    ...
    public boolean execute(CommandSender commandSender, String s, String[] strings) {
        ...
        if(!(commandSender instanceof Player)) {
            ...
            if(player != null && player.isOnline()){
                CharmPoint.setCharmPoint(player, Double.valueOf(strings[1]));
            }else{
